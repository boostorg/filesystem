...
namespace
{
  ...
  //{
  //  if (s.type() == fs::status_error)        { os << "none"; }
  //  else if (s.type() == fs::file_type::not_found) { os << "not_found"; }
  //  else if (s.type() == fs::file_type::regular)   { os << "regular"; }
  //  else if (s.type() == fs::file_type::directory) { os << "directory"; }
  //  else if (s.type() == fs::file_type::symlink)   { os << "symlink"; }
  //  else if (s.type() == fs::file_type::block)     { os << "block"; }
  //  else if (s.type() == fs::file_type::character ) { os << "character"; }
  //  else if (s.type() == fs::file_type::fifo )      { os << "fifo"; }
  //  else if (s.type() == fs::file_type::socket )    { os << "socket"; }
  //  else if (s.type() == fs::file_type::reparse )   { os << "reparse"; }
  //  else if (s.type() == fs::file_type::unknown)   { os << "unknown"; }
