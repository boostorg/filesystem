...
namespace detail
{
struct BOOST_FILESYSTEM_DECL utf8_codecvt_facet :
    public std::codecvt<wchar_t, char, std::mbstate_t>  
{
private: // do now allow copying
    utf8_codecvt_facet( const utf8_codecvt_facet & );
    const utf8_codecvt_facet & operator=( const utf8_codecvt_facet & );
public:
