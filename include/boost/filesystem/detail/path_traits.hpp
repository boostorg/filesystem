...
{
    using source_t = typename path_traits::make_dependent< boost::container::basic_string< char, std::char_traits< char >, void, void >, Source >::type;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
{
    using source_t = typename path_traits::make_dependent< boost::container::basic_string< wchar_t, std::char_traits< wchar_t >, void, void >, Source >::type;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
